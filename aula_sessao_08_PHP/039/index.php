...
/*
   ...
   Vamos considerar 3 níveis.
   1- Ao nível do HTML5, quando usamos atributos no formulário
   2- Através do JavaScript, antes da submissão do formulário
   3- Ao nível do servidor, quando o formulário é submetido

   Uma boa prática é ter os 3 níveis de validação.
   Mas uma vez que os dois primeiros acontecem do lado do cliente, é fundamental nunca esquecer o terceiro nível: a validação do lado do serivodr.
   */
